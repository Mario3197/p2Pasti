...
set ::bali::simulation::Para(PROJECT) {simulacion}
set ::bali::simulation::Para(PROJECTPATH) {A:/Documentos/Aruitectura Pasti}
set ::bali::simulation::Para(FILELIST) {"A:/Documentos/Aruitectura Pasti/paquete.vhd" "A:/Documentos/Aruitectura Pasti/OperacionesLogicas.vhd" }
...
set ::bali::simulation::Para(SIMULATIONTOPMODULE) {OperacionesLogicas}
